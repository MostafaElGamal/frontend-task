<template>
  <div class="container">
    ...
    <TeamsMember :teamsMember="teamsMember" />
  </div>
</template>

<script>
import HomeHeader from "vue/components/Home/_HomeHeader";
import Features from "vue/components/Home/_Features";
import TeamsMember from "vue/components/Home/_TeamsMember";

export default {
  name: "feature-list",
  components: { HomeHeader, Features, TeamsMember },
  data() {
    return {
      featuresData: [],
      teamsMember: [],
    ...
    async getFeaturesList() {
      try {
        ...
        if (featuresRes.data.success === true) {
          this.featuresData = featuresRes.data.features;
          this.teamsMember = featuresRes.data.team_members;
        }
      } catch (error) {
        console.log(error);
      }
